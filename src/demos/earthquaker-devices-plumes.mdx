...
model: Plumes
slug: earthquaker_devices_plumes
image: ../images/earthquaker-devices-plumes.webp
pedalData: ../data/earthquaker-devices-plumes.pedal.json
presetsData: ../data/earthquaker-devices-plumes.presets.json
type: demo
date: 2021-01-04
---
...
- Get detailed specs on [Earthquaker Devices' website](https://www.earthquakerdevices.com/plumes)
- Get a good deal on it on [Reverb](https://reverb.grsm.io/loopydemos-earthquaker-devices-plumes)
- Try a new one from [Thomann](https://www.thomann.de/intl/earthquaker_devices_devices_plumes_signal_shredder.htm?partner_id=15606) and use their great **30-Day Money-Back Guarantee** if it's not for you
