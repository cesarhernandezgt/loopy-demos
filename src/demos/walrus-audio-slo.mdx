...
pedalData: ../data/walrus-audio-slo.pedal.json
presetsData: ../data/walrus-audio-slo.presets.json
type: demo
date: 2020-11-12
---
...
- Get detailed specs on [Walrus Audio's website](https://www.walrusaudio.com/products/slo-multi-texture-reverb)
- Get a good deal on it on [Reverb](https://reverb.grsm.io/loopydemos-walrus-audio-slo)
- Try a new one from [Thomann](https://www.thomann.de/intl/walrus_audio_sloe_multi_texture_reverb.htm?partner_id=15606) and use their great **30-Day Money-Back Guarantee** if it's not for you
