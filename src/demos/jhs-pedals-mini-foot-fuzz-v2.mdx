...
pedalData: ../data/jhs-pedals-mini-foot-fuzz-v2.pedal.json
presetsData: ../data/jhs-pedals-mini-foot-fuzz-v2.presets.json
type: demo
date: 2021-01-10
---
...
- Get detailed specs on [JHS Pedals' website](https://www.jhspedals.info/mini-foot-fuzz-v2)
- Get a good deal on it on [Reverb](https://reverb.grsm.io/loopydemos-jhs-mini-foot-fuzz)
- Try a new one from [Thomann](https://www.thomann.de/intl/jhs_pedals_mini_foot_fuzz_v2.htm?partner_id=15606) and use their great **30-Day Money-Back Guarantee** if it's not for you
