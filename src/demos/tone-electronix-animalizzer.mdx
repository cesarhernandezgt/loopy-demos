...
pedalData: ../data/tone-electronix-animalizzer.pedal.json
presetsData: ../data/tone-electronix-animalizzer.presets.json
type: demo
date: 2021-02-16
---
...
- Order one from [T.X Pedals](https://txpedals.weebly.com/shop.html) directly. There's also more detailed info about the Animalizzer
- Get a good deal on it on [Reverb](https://reverb.grsm.io/loopydemos-tone-electronix-animalizzer)
